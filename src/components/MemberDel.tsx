...
const MemberDelete: React.FC<MemberProps> = (props) => {
    ...
    return (
        <div className="flex z-10 fixed inset-0 items-center justify-center h-[40rem]">
            <div className="fixed inset-0 bg-opacity-80 bg-black" onClick={closeModal}/>
            <div className="w-[520px] bg-gray-50 rounded-lg shadow-xl relative top-[-30px]">
                ...
                <div className="px-5 py-4 text-left text-gray-500 tracking-wide">
                    <h2 className="text-xl font-semibold mb-3 text-gray-700">Remove Member</h2>
                    <div className="border-t border-gray-400 w-full mt-1"/>
                    <form className="text-[16px] text-gray-200">                        
                        <div className="text-gray-700 flex justify-center text-[17px] pt-5 pb-2">
