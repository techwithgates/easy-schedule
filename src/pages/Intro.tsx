...
export default function Intro() {
    return (
        <div className="fixed w-full top-0 left-0">
            <div className="p-5 bg-zinc-800 flex gap-5">
                ...
                <h1 className="text-gray-100 text-[30px] font-semibold text-left">Easy Schedule</h1>
                <Link to={'/solution'}>
                    <div className='p-4 bg-blue-600 w-30 text-white rounded-lg hover:bg-blue-500 cursor-pointer tracking-wider'>
                        Getting Started
                    </div>
                </Link>
            </div>
            <div className="px-20 pt-10 text-[17px] text-left text-gray-700 ">
                <div>
                    <h1 className='font-semibold text-[22px] pb-1'>Introduction</h1>
                    Easy Schedule is a simple software tool that can help you find the common available times among your team members.
                </div>
                <div className='pt-3'>
                    <h1 className='font-semibold text-[22px] pb-1'>How to use this tool?</h1>
                    <div>
                ...
                <div className='pt-3'>
                    <h1 className='font-semibold text-[22px] pb-1'>Rules & Constraints</h1>
                    <div>
